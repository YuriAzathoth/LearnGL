...
CGLM_INLINE
void glm_mat4_scale_sse2(mat4 m, float s)
{
	__m128 x0;
	x0 = _mm_set1_ps(s);
...
CGLM_INLINE
void glm_mat4_transp_sse2(mat4 m, mat4 dest)
{
	__m128 r0, r1, r2, r3;
...
CGLM_INLINE
void glm_mat4_mul_sse2(mat4 m1, mat4 m2, mat4 dest)
{
	/* D = R * L (Column-Major) */
	...
	r = glmm_load(m2[0]);
	glmm_store(dest[0],
			   _mm_add_ps(_mm_add_ps(_mm_mul_ps(glmm_shuff1x(r, 0), l0), _mm_mul_ps(glmm_shuff1x(r, 1), l1)),
						  _mm_add_ps(_mm_mul_ps(glmm_shuff1x(r, 2), l2), _mm_mul_ps(glmm_shuff1x(r, 3), l3))));
	r = glmm_load(m2[1]);
	glmm_store(dest[1],
			   _mm_add_ps(_mm_add_ps(_mm_mul_ps(glmm_shuff1x(r, 0), l0), _mm_mul_ps(glmm_shuff1x(r, 1), l1)),
						  _mm_add_ps(_mm_mul_ps(glmm_shuff1x(r, 2), l2), _mm_mul_ps(glmm_shuff1x(r, 3), l3))));
...
CGLM_INLINE
void glm_mat4_mulv_sse2(mat4 m, vec4 v, vec4 dest)
{
	__m128 x0, x1, x2;

	x0 = glmm_load(v);
	x1 = _mm_add_ps(_mm_mul_ps(glmm_load(m[0]), glmm_shuff1x(x0, 0)), _mm_mul_ps(glmm_load(m[1]), glmm_shuff1x(x0, 1)));

	x2 = _mm_add_ps(_mm_mul_ps(glmm_load(m[2]), glmm_shuff1x(x0, 2)), _mm_mul_ps(glmm_load(m[3]), glmm_shuff1x(x0, 3)));

	glmm_store(dest, _mm_add_ps(x1, x2));
}

CGLM_INLINE
float glm_mat4_det_sse2(mat4 mat)
{
	...
	/*
	 ...
	 t[4] = i * o - m * k;
	 */
	x0 = _mm_sub_ps(_mm_mul_ps(glmm_shuff1(r2, 0, 0, 1, 1), glmm_shuff1(r3, 2, 3, 2, 3)),
					_mm_mul_ps(glmm_shuff1(r3, 0, 0, 1, 1), glmm_shuff1(r2, 2, 3, 2, 3)));
	/*
	 t[0] = k * p - o * l;
	 t[0] = k * p - o * l;
	 t[5] = i * n - m * j;
	 t[5] = i * n - m * j;
	 */
	x1 = _mm_sub_ps(_mm_mul_ps(glmm_shuff1(r2, 0, 0, 2, 2), glmm_shuff1(r3, 1, 1, 3, 3)),
					_mm_mul_ps(glmm_shuff1(r3, 0, 0, 2, 2), glmm_shuff1(r2, 1, 1, 3, 3)));
	...
	/*
	 ...
	 - d * (e * t[2] - f * t[4] + g * t[5])
	 */
	x2 = _mm_sub_ps(_mm_mul_ps(glmm_shuff1(r1, 0, 0, 0, 1), _mm_shuffle_ps(x1, x0, _MM_SHUFFLE(1, 0, 0, 0))),
					_mm_mul_ps(glmm_shuff1(r1, 1, 1, 2, 2), glmm_shuff1(x0, 3, 2, 2, 0)));

	x2 = _mm_add_ps(x2, _mm_mul_ps(glmm_shuff1(r1, 2, 3, 3, 3), _mm_shuffle_ps(x0, x1, _MM_SHUFFLE(2, 2, 3, 1))));
...
CGLM_INLINE
void glm_mat4_inv_fast_sse2(mat4 mat, mat4 dest)
{
	__m128 r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7;
	...
	v0 = _mm_add_ps(_mm_mul_ps(x3, t2), _mm_sub_ps(_mm_mul_ps(x1, t0), _mm_mul_ps(x2, t1)));
	...
	v1 = _mm_add_ps(_mm_mul_ps(x3, t4), _mm_sub_ps(_mm_mul_ps(x0, t0), _mm_mul_ps(x2, t3)));
	...
	v2 = _mm_add_ps(_mm_mul_ps(x3, t5), _mm_sub_ps(_mm_mul_ps(x0, t1), _mm_mul_ps(x1, t3)));
	...
	v3 = _mm_add_ps(_mm_mul_ps(x2, t5), _mm_sub_ps(_mm_mul_ps(x0, t2), _mm_mul_ps(x1, t4)));
...
CGLM_INLINE
void glm_mat4_inv_sse2(mat4 mat, mat4 dest)
{
	__m128 r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7;
