...
static inline float glmm_hadd(float32x4_t v)
{
...
static inline float glmm_hmin(float32x4_t v)
{
	float32x2_t t;
...
static inline float glmm_hmax(float32x4_t v)
{
	float32x2_t t;
...
static inline float glmm_dot(float32x4_t a, float32x4_t b)
{
...
static inline float glmm_norm_inf(float32x4_t a)
{
