 ...
 */
CGLM_INLINE
float glms_vec3_dot(vec3s a, vec3s b)
{
 ...
 */
CGLM_INLINE
float glms_vec3_norm_one(vec3s v)
{
 ...
 */
CGLM_INLINE
float glms_vec3_norm_inf(vec3s v)
{
 ...
 */
CGLM_INLINE
float glms_vec3_angle(vec3s a, vec3s b)
{
