 ...
 */
CGLM_INLINE
vec4s glms_vec4_broadcast(float val)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_fill(float val)
{
	vec4s r;
 ...
 */
CGLM_INLINE
bool glms_vec4_eq(vec4s v, float val)
{
 ...
 */
CGLM_INLINE
bool glms_vec4_eq_eps(vec4s v, float val)
{
 ...
 */
CGLM_INLINE
bool glms_vec4_eqv(vec4s a, vec4s b)
{
 ...
 */
CGLM_INLINE
bool glms_vec4_eqv_eps(vec4s a, vec4s b)
{
 ...
 */
CGLM_INLINE
bool glms_vec4_isvalid(vec4s v)
{
