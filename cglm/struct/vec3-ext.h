 ...
 */
CGLM_INLINE
bool glms_vec3_eq(vec3s v, float val)
{
 ...
 */
CGLM_INLINE
bool glms_vec3_eqv(vec3s a, vec3s b)
{
 ...
 */
CGLM_INLINE
bool glms_vec3_isvalid(vec3s v)
{
