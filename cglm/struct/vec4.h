...
#define GLMS_VEC4_ONE_INIT                                                                                             \
	{                                                                                                                  \
		GLM_VEC4_ONE_INIT                                                                                              \
	}
#define GLMS_VEC4_BLACK_INIT                                                                                           \
	{                                                                                                                  \
		GLM_VEC4_BLACK_INIT                                                                                            \
	}
#define GLMS_VEC4_ZERO_INIT                                                                                            \
	{                                                                                                                  \
		GLM_VEC4_ZERO_INIT                                                                                             \
	}
 ...
 */
CGLM_INLINE
vec4s glms_vec4(vec3s v3, float last)
{
	vec4s r;
 ...
 */
CGLM_INLINE
void glms_vec4_pack(vec4s dst[], vec4 src[], size_t len)
{
	size_t i;
 ...
 */
CGLM_INLINE
void glms_vec4_unpack(vec4 dst[], vec4s src[], size_t len)
{
	size_t i;
 ...
 */
CGLM_INLINE
float glms_vec4_dot(vec4s a, vec4s b)
{
 ...
 */
CGLM_INLINE
float glms_vec4_norm_one(vec4s v)
{
 ...
 */
CGLM_INLINE
float glms_vec4_norm_inf(vec4s v)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_add(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_adds(vec4s v, float s)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_sub(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_subs(vec4s v, float s)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_mul(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_scale(vec4s v, float s)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_scale_as(vec4s v, float s)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_div(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_divs(vec4s v, float s)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_addadd(vec4s a, vec4s b, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_subadd(vec4s a, vec4s b, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_muladd(vec4s a, vec4s b, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_muladds(vec4s a, float s, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_maxadd(vec4s a, vec4s b, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_minadd(vec4s a, vec4s b, vec4s dest)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_negate(vec4s v)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_normalize(vec4s v)
{
 ...
 */
CGLM_INLINE
float glms_vec4_distance(vec4s a, vec4s b)
{
 ...
 */
CGLM_INLINE
float glms_vec4_distance2(vec4s a, vec4s b)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_maxv(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_minv(vec4s a, vec4s b)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_clamp(vec4s v, float minVal, float maxVal)
{
 ...
 */
CGLM_INLINE
vec4s glms_vec4_lerp(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_lerpc(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_mix(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_mixc(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_step_uni(float edge, vec4s x)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_step(vec4s edge, vec4s x)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_smoothstep_uni(float edge0, float edge1, vec4s x)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_smoothstep(vec4s edge0, vec4s edge1, vec4s x)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_smoothinterp(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_smoothinterpc(vec4s from, vec4s to, float t)
{
	vec4s r;
 ...
 */
CGLM_INLINE
vec4s glms_vec4_swizzle(vec4s v, int mask)
{
	vec4s dest;
