 ...
 */
CGLM_INLINE
bool glms_vec2_eq(vec2s v, float val)
{
 ...
 */
CGLM_INLINE
bool glms_vec2_eq_eps(vec2s v, float val)
{
 ...
 */
CGLM_INLINE
bool glms_vec2_eqv(vec2s a, vec2s b)
{
 ...
 */
CGLM_INLINE
bool glms_vec2_eqv_eps(vec2s a, vec2s b)
{
