 ...
 */
CGLM_INLINE
mat4s glms_frustum(float left, float right, float bottom, float top, float nearVal, float farVal)
{
	mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_ortho(float left, float right, float bottom, float top, float nearVal, float farVal)
{
	mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_perspective(float fovy, float aspect, float nearVal, float farVal)
{
	mat4s dest;
 ...
 */
CGLM_INLINE
void glms_persp_move_far(mat4s proj, float deltaFar)
{
 ...
 */
CGLM_INLINE
void glms_perspective_resize(mat4s proj, float aspect)
{
 ...
 */
CGLM_INLINE
void glms_persp_decomp_z(mat4s proj, float* __restrict nearVal, float* __restrict farVal)
{
 ...
 */
CGLM_INLINE
void glms_persp_decomp_far(mat4s proj, float* __restrict farVal)
{
 ...
 */
CGLM_INLINE
void glms_persp_decomp_near(mat4s proj, float* __restrict nearVal)
{
