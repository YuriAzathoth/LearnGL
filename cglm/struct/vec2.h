...
#define GLMS_VEC2_ONE_INIT                                                                                             \
	{                                                                                                                  \
		GLM_VEC2_ONE_INIT                                                                                              \
	}
#define GLMS_VEC2_ZERO_INIT                                                                                            \
	{                                                                                                                  \
		GLM_VEC2_ZERO_INIT                                                                                             \
	}
 ...
 */
CGLM_INLINE
void glms_vec2_pack(vec2s dst[], vec2 src[], size_t len)
{
	size_t i;
 ...
 */
CGLM_INLINE
void glms_vec2_unpack(vec2 dst[], vec2s src[], size_t len)
{
	size_t i;
 ...
 */
CGLM_INLINE
float glms_vec2_dot(vec2s a, vec2s b)
{
 ...
 */
CGLM_INLINE
float glms_vec2_cross(vec2s a, vec2s b)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_add(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_adds(vec2s a, float s)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_sub(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_subs(vec2s a, float s)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_mul(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_scale(vec2s v, float s)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_scale_as(vec2s v, float s)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_div(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_divs(vec2s a, float s)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_addadd(vec2s a, vec2s b, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_subadd(vec2s a, vec2s b, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_muladd(vec2s a, vec2s b, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_muladds(vec2s a, float s, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_maxadd(vec2s a, vec2s b, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_minadd(vec2s a, vec2s b, vec2s dest)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_negate(vec2s v)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_normalize(vec2s v)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_rotate(vec2s v, float angle)
{
	vec2s r;
 ...
 */
CGLM_INLINE
float glms_vec2_distance(vec2s a, vec2s b)
{
 ...
 */
CGLM_INLINE
float glms_vec2_distance2(vec2s a, vec2s b)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_maxv(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_minv(vec2s a, vec2s b)
{
	vec2s r;
 ...
 */
CGLM_INLINE
vec2s glms_vec2_clamp(vec2s v, float minVal, float maxVal)
{
 ...
 */
CGLM_INLINE
vec2s glms_vec2_lerp(vec2s from, vec2s to, float t)
{
	vec2s r;
