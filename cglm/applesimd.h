...
#if defined(__APPLE__) && defined(SIMD_COMPILER_HAS_REQUIRED_FEATURES) && defined(SIMD_BASE) && defined(SIMD_TYPES) && \
 ...
 */
CGLM_INLINE
simd_float4x4 glm_mat4_applesimd(mat4 m)
{
	simd_float4x4 t;
 ...
 */
CGLM_INLINE
simd_float3x3 glm_mat3_applesimd(mat3 m)
{
	simd_float3x3 t;
 ...
 */
CGLM_INLINE
simd_float4 glm_vec4_applesimd(vec4 v)
{
 ...
 */
CGLM_INLINE
simd_float3 glm_vec3_applesimd(vec3 v)
{
