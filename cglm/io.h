...
#ifndef cglm_io_h
#define cglm_io_h
#if defined(DEBUG) || defined(_DEBUG) || defined(CGLM_DEFINE_PRINTS) || defined(CGLM_LIB_SRC) ||                       \
...
CGLM_INLINE
void glm_mat2_print(mat2 matrix, FILE* __restrict ostream)
{
	char buff[16];
	int i, j, cw[4], cwi;
...
CGLM_INLINE
void glm_vec2_print(vec2 vec, FILE* __restrict ostream)
{
	int i;
...
CGLM_INLINE
void glm_aabb_print(vec3 bbox[2], const char* __restrict tag, FILE* __restrict ostream)
{
	int i, j;
...
#define glm_mat4_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_mat3_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_mat2_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_vec4_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_vec3_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_ivec3_print(v, s)                                                                                          \
	(void)v;                                                                                                           \
	(void)s;
#define glm_vec2_print(v, s)                                                                                           \
	(void)v;                                                                                                           \
	(void)s;
#define glm_versor_print(v, s)                                                                                         \
	(void)v;                                                                                                           \
	(void)s;
#define glm_aabb_print(v, t, s)                                                                                        \
	(void)v;                                                                                                           \
	(void)t;                                                                                                           \
	(void)s;
