...
CGLM_INLINE
glm_euler_seq glm_euler_order(int ord[3])
{
...
{
	float cx, cy, cz, sx, sy, sz, sxsy, cysx, cxsy, cxcy;
...
{
	float cx, cy, cz, sx, sy, sz, cycz, sysz, czsy, cysz;
...
{
	float cx, cy, cz, sx, sy, sz, sxsy, cxcy, cysx, cxsy;
...
{
	float cx, cy, cz, sx, sy, sz, cycz, sxsy, cysz;
...
void glm_euler_by_order(vec3 angles, glm_euler_seq ord, mat4 dest)
{
	...
	float cycz, cysz, cysx, cxcy, czsy, cxcz, czsx, cxsz, sysz;
